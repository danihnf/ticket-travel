	...
	<div class="col-md-7 bann-info wow fadeInRight animated" data-wow-delay=".5s">
		...
		<div class="ban-top">
			...
			<div class="bnr-left">
				...
				<input name="from" class="city" type="text" value="Enter a city" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter a city';}" required=>
			</div>

			<div class="bnr-left">
				<label class="inputLabel">To</label>
				<input name="to" class="city" type="text" value="Enter a city" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter a city';}" required=>
			</div>
		...
		<div class="ban-bottom">
			<div class="bnr-right">
				...
				<input name="depart" class="date" id="datepicker" type="text" value="dd-mm-yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'dd-mm-yyyy';}" required=>
			</div>
			<div class="bnr-right">
