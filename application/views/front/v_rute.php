...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> <?php echo $dari ?> → <?php echo $ke; ?></h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- bus-tp ---->
<div class="bus-tp">
	<div class="container">
		<p><?php echo date('D , d M Y',strtotime($depart)); ?></p>
		<div class="clearfix"></div>
	</div>
</div>
<!--- /bus-tp ---->
